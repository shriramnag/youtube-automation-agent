...
function renderLearning(learning = {}) {
  ...
  $('#learning-recommendations').innerHTML = recommendations.length ? recommendations.map(item => `
    ...
    </article>`).join('') : empty('No recommendation yet. Shiv AI needs at least two real, sufficiently exposed measurements.');
}
  ...
  if (milestones.firstRealVideo?.achieved) {
    container.insertAdjacentHTML('beforeend', `
      <div class="activation-share">
        <span>Made something real with Shiv AI?</span>
        <a class="button secondary small" href="https://github.com/shriramnag/youtube-automation-agent/discussions/new?category=show-and-tell" target="_blank" rel="noreferrer">Share what you built</a>
      </div>`);
  }
}
...
function switchView(view) {
  ...
  const titles = {
    ...
    operator: ['AUTONOMOUS OPERATOR', 'Give Shiv AI the strategy.'],
...
document.addEventListener('click', async event => {
  ...
  if (experiment) {
    ...
    const prompts = {
      ...
      start: 'Start this live test? Shiv AI will rotate only the approved arms and restore the control before asking you to adopt a winner.',
