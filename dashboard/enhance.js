/* ============================================================
   Shiv AI console enhancement layer — motion, command palette,
...
(() => {
  ...
  const VIEW_META = {
    ...
    operator: ['AUTONOMOUS OPERATOR', 'Give Shiv AI the strategy.', 'Operator'],
  ...
  if (typeof baseSwitchView === 'function') {
    window.switchView = function (view) {
      ...
      currentView = view;
      baseSwitchView(view);
      document.title = `${VIEW_META[view][2]} · Shiv AI`;
  ...
  palette.innerHTML = `
    <div class="cmdk" role="dialog" aria-modal="true" aria-label="Command palette">
      ...
      <div class="cmdk-foot"><span><kbd>↑</kbd><kbd>↓</kbd> navigate</span><span><kbd>↵</kbd> run</span><span class="cmdk-brand">Shiv AI console</span></div>
    </div>`;
